...
Important Note: This package is just an example that I used to study how to create a package and add some elements to the documentation; the functions are not necessarily original ideas.
